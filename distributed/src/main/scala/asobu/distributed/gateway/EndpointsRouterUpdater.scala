...
//import asobu.distributed.EndpointsRegistry.EndpointDefinitionSets
//
...
//    def updateEndpoints(data: LWWMap[EndpointDefinitionSets]): Unit = {
...
//     */
//    def update[A](data: A)(extract: A ⇒ LWWMap[EndpointDefinitionSets]): Unit = {
//      val results = extract(data)
//      if (!results.entries.headOption.forall(_._2.isInstanceOf[EndpointDefinitionSets])) {
